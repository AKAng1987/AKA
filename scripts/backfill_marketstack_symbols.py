"""
backfill_marketstack_symbols.py -- Backfill any marketstack symbols (SYMBOLS=A,B,C env)
...
SYMBOLS = [(s, s) for s in os.environ["SYMBOLS"].split(",")]
DATE_FROM = os.environ.get("DATE_FROM", "2008-03-27")
DATE_TO   = os.environ.get("DATE_TO", "2026-09-10")
